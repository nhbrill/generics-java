...
* AUTHOR: Nate Brill
* FILE: ListStack.java
* PURPOSE: To implement a stack backed by a linked list with generic's.
*/
public class ListStack<E> implements StackInterface<E> {
    ...
    public void push(E value) {
        ...
        Node<E> newNode = new Node<E>(value, temp);
        this.front = newNode;
    }
    ...
    public ListStack<E> copy() {
         ...
         */
        ListStack<E> newStack = new ListStack<E>();
        newStack.front = this.front;
        return newStack;
    }
